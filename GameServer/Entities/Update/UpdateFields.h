...
enum EObjectFields
{   
    OBJECT_FIELD_GUID = 0x0000,     //占两个uint32 ObjectGuid
    OBJECT_FIELD_TYPE = 0x0002,     //占一个uint32 
    OBJECT_FIELD_ENTRY = 0x0003,    //占一个uint32 模版id 比如多个近战小兵共用一个模板
    OBJECT_FIELD_SCALE_X = 0x0004,  //占一个float 缩放比例
    OBJECT_FIELD_PADDING = 0x0005,  //填充字段 占一个uint32没有实际意义
    OBJECT_END = 0x0006,
};
