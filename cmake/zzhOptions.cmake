...
add_library(zzh_options INTERFACE)
...
target_compile_options(zzh_options INTERFACE
...
target_link_options(zzh_options INTERFACE
    $<$<AND:$<PLATFORM_ID:Linux>,$<OR:$<CXX_COMPILER_ID:GNU>,$<CXX_COMPILER_ID:Clang>>>:
        -rdynamic
    >
)

# Debug 模式下定义 ZZH_DEBUG 宏，用于代码中的调试逻辑判断
target_compile_definitions(zzh_options INTERFACE
    $<$<CONFIG:Debug>:ZZH_DEBUG>
)
